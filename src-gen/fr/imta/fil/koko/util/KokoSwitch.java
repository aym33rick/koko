 ...
 * @generated
 */
public class KokoSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case KokoPackage.RESTAURANT: {
				Restaurant restaurant = (Restaurant)theEObject;
				T result = caseRestaurant(restaurant);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KokoPackage.EMPLOYEE: {
				Employee employee = (Employee)theEObject;
				T result = caseEmployee(employee);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KokoPackage.PLAT: {
				Plat plat = (Plat)theEObject;
				T result = casePlat(plat);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KokoPackage.CLIENT: {
				Client client = (Client)theEObject;
				T result = caseClient(client);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KokoPackage.SERVEUR: {
				Serveur serveur = (Serveur)theEObject;
				T result = caseServeur(serveur);
				if (result == null) result = caseEmployee(serveur);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KokoPackage.CUISINIER: {
				Cuisinier cuisinier = (Cuisinier)theEObject;
				T result = caseCuisinier(cuisinier);
				if (result == null) result = caseEmployee(cuisinier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Plat</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Plat</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePlat(Plat object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Cuisinier</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Cuisinier</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCuisinier(Cuisinier object) {
		return null;
	}
